-- --------------------------------------------------------
-- 主机:                           tomriddleatnj.eicp.net
-- 服务器版本:                        5.5.59-0ubuntu0.14.04.1 - (Ubuntu)
...
-- 导出 seahub-db 的数据库结构
CREATE DATABASE IF NOT EXISTS `seahub-db` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `seahub-db`;

-- 导出  表 seahub-db.admin_log_adminlog 结构
...
-- 正在导出表  seahub-db.captcha_captchastore 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `captcha_captchastore` DISABLE KEYS */;
/*!40000 ALTER TABLE `captcha_captchastore` ENABLE KEYS */;

-- 导出  表 seahub-db.constance_config 结构
...
-- 正在导出表  seahub-db.django_content_type 的数据：~63 rows (大约)
/*!40000 ALTER TABLE `django_content_type` DISABLE KEYS */;
INSERT INTO `django_content_type` (`id`, `app_label`, `model`) VALUES
	(50, 'admin_log', 'adminlog'),
	(12, 'api2', 'token'),
	(13, 'api2', 'tokenv2'),
	(14, 'avatar', 'avatar'),
	(15, 'avatar', 'groupavatar'),
	(17, 'base', 'clientlogintoken'),
	(22, 'base', 'commandslastcheck'),
	(21, 'base', 'devicetoken'),
	(19, 'base', 'filecomment'),
	(20, 'base', 'filediscuss'),
	(16, 'base', 'groupenabledmodule'),
	(23, 'base', 'innerpubmsg'),
	(24, 'base', 'innerpubmsgreply'),
	(18, 'base', 'userenabledmodule'),
	(25, 'base', 'userlastlogin'),
	(26, 'base', 'userstarredfiles'),
	(4, 'captcha', 'captchastore'),
	(27, 'contacts', 'contact'),
	(1, 'contenttypes', 'contenttype'),
	(5, 'database', 'constance'),
	(35, 'group', 'groupmessage'),
	(36, 'group', 'messageattachment'),
	(37, 'group', 'messagereply'),
	(34, 'group', 'publicgroup'),
	(29, 'institutions', 'institution'),
	(28, 'institutions', 'institutionadmin'),
	(30, 'institutions', 'institutionquota'),
	(31, 'invitations', 'invitation'),
	(38, 'notifications', 'notification'),
	(39, 'notifications', 'usernotification'),
	(40, 'options', 'useroptions'),
	(63, 'organizations', 'orgmemberquota'),
	(6, 'post_office', 'attachment'),
	(8, 'post_office', 'email'),
	(7, 'post_office', 'emailtemplate'),
	(9, 'post_office', 'log'),
	(42, 'profile', 'detailedprofile'),
	(41, 'profile', 'profile'),
	(3, 'registration', 'registrationprofile'),
	(54, 'revision_tag', 'revisiontags'),
	(55, 'revision_tag', 'tags'),
	(60, 'role_permissions', 'adminrole'),
	(2, 'sessions', 'session'),
	(49, 'share', 'anonymousshare'),
	(48, 'share', 'extragroupssharepermission'),
	(47, 'share', 'extrasharepermission'),
	(44, 'share', 'fileshare'),
	(45, 'share', 'orgfileshare'),
	(43, 'share', 'privatefiledirshare'),
	(46, 'share', 'uploadlinkshare'),
	(62, 'sysadmin_extra', 'userloginlog'),
	(52, 'tags', 'filetag'),
	(51, 'tags', 'fileuuidmap'),
	(53, 'tags', 'tags'),
	(10, 'termsandconditions', 'termsandconditions'),
	(11, 'termsandconditions', 'usertermsandconditions'),
	(61, 'trusted_ip', 'trustedip'),
	(56, 'two_factor', 'phonedevice'),
	(59, 'two_factor', 'staticdevice'),
	(57, 'two_factor', 'statictoken'),
	(58, 'two_factor', 'totpdevice'),
	(33, 'wiki', 'groupwiki'),
	(32, 'wiki', 'personalwiki');
/*!40000 ALTER TABLE `django_content_type` ENABLE KEYS */;

-- 导出  表 seahub-db.django_migrations 结构
...
-- 正在导出表  seahub-db.django_migrations 的数据：~18 rows (大约)
/*!40000 ALTER TABLE `django_migrations` DISABLE KEYS */;
INSERT INTO `django_migrations` (`id`, `app`, `name`, `applied`) VALUES
	(1, 'admin_log', '0001_initial', '2017-09-25 05:24:11'),
	(2, 'captcha', '0001_initial', '2017-09-25 05:24:11'),
	(3, 'contenttypes', '0001_initial', '2017-09-25 05:24:11'),
	(4, 'contenttypes', '0002_remove_content_type_name', '2017-09-25 05:24:11'),
	(5, 'database', '0001_initial', '2017-09-25 05:24:11'),
	(6, 'institutions', '0001_initial', '2017-09-25 05:24:11'),
	(7, 'institutions', '0002_institutionquota', '2017-09-25 05:24:11'),
	(8, 'invitations', '0001_initial', '2017-09-25 05:24:11'),
	(9, 'invitations', '0002_invitation_invite_type', '2017-09-25 05:24:11'),
	(10, 'invitations', '0003_auto_20160510_1703', '2017-09-25 05:24:11'),
	(11, 'invitations', '0004_auto_20160629_1610', '2017-09-25 05:24:11'),
	(12, 'invitations', '0005_auto_20160629_1614', '2017-09-25 05:24:11'),
	(13, 'post_office', '0001_initial', '2017-09-25 05:24:12'),
	(14, 'post_office', '0002_add_i18n_and_backend_alias', '2017-09-25 05:24:12'),
	(15, 'post_office', '0003_auto_20170725_0206', '2017-09-25 05:24:12'),
	(16, 'role_permissions', '0001_initial', '2017-09-25 05:24:12'),
	(17, 'sessions', '0001_initial', '2017-09-25 05:24:12'),
	(18, 'termsandconditions', '0001_initial', '2017-09-25 05:24:12');
/*!40000 ALTER TABLE `django_migrations` ENABLE KEYS */;

-- 导出  表 seahub-db.django_session 结构
...
-- 正在导出表  seahub-db.django_session 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `django_session` DISABLE KEYS */;
/*!40000 ALTER TABLE `django_session` ENABLE KEYS */;

-- 导出  表 seahub-db.group_groupmessage 结构
...
-- 正在导出表  seahub-db.notifications_usernotification 的数据：~0 rows (大约)
...
-- 导出  表 seahub-db.options_useroptions 结构
...
-- 正在导出表  seahub-db.profile_profile 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `profile_profile` DISABLE KEYS */;
/*!40000 ALTER TABLE `profile_profile` ENABLE KEYS */;

-- 导出  表 seahub-db.registration_registrationprofile 结构
...
-- 正在导出表  seahub-db.registration_registrationprofile 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `registration_registrationprofile` DISABLE KEYS */;
/*!40000 ALTER TABLE `registration_registrationprofile` ENABLE KEYS */;

-- 导出  表 seahub-db.revision_tag_revisiontags 结构
...
-- 正在导出表  seahub-db.share_extragroupssharepermission 的数据：~0 rows (大约)
...
-- 导出  表 seahub-db.share_extrasharepermission 结构
...
-- 正在导出表  seahub-db.tags_tags 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `tags_tags` DISABLE KEYS */;
/*!40000 ALTER TABLE `tags_tags` ENABLE KEYS */;

-- 导出  表 seahub-db.termsandconditions_termsandconditions 结构
...
-- 正在导出表  seahub-db.termsandconditions_termsandconditions 的数据：~0 rows (大约)
...
-- 导出  表 seahub-db.termsandconditions_usertermsandconditions 结构
...
-- 正在导出表  seahub-db.termsandconditions_usertermsandconditions 的数据：~0 rows (大约)
...
-- 导出  表 seahub-db.trusted_ip_trustedip 结构
...
-- 正在导出表  seahub-db.wiki_personalwiki 的数据：~0 rows (大约)
